...
def Submit_Category(request):
   try:
    ...
    Q="Insert into categories(categoryname,categoryicon) value('{0}','{1}')".format(categoryname,categoryicon.name)
    F=open("C:/Users/Public/django/medassist_ecom/assets"+categoryicon.name,'wb')
